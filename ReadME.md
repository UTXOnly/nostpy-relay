...
A containerized Python relay paried with a Postgres databse, reachable via a NGINX reverse proxy. This has been tested on [Iris.to](Iris.to) and [Snort.social](Snort.social) clients and works for the NIPS listed below.
